...
if __name__ == '__main__':
    print('train:', count_split_examples('/playground/data/WIDERFace/tfrecords', 'train-?????-of-?????'))
    print('val:', count_split_examples('/playground/data/WIDERFace/tfrecords', 'val-?????-of-?????'))
